    # Lab 07 — HCC Flash Cache Storage Indexes

    ## Objectif

    Relier HCC, Flash Cache et Storage Indexes à des preuves observables. Ce lab est conçu pour produire une preuve exploitable, spécifique Exadata, en privilégiant les commandes de lecture et les requêtes `SELECT`.
...
select table_name,compression,compress_for from dba_tables;
    ...
    `hcc-flash-storage-indexes.md` avec contexte, commandes, résultats, interprétation, risques, recommandations et annexes.
