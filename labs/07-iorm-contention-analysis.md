# Lab 07 — IORM contention analysis

## Objectif

Ce lab vise à analyser les politiques IORM et symptômes de voisinage. Il est conçu pour être exécuté en priorité en environnement de formation ou de préproduction. Les commandes sont indicatives et doivent être adaptées à votre version et à vos droits.
...
```bash
mkdir -p evidence/lab-07-$(date +%Y%m%d-%H%M%S)
hostname -f
date
uname -a
ip -br addr
