    # Lab 09 — Enterprise Manager monitoring checklist

    ## Objectif

    Vérifier agents, targets, incidents, blackouts et collecte EM. Ce lab est conçu pour produire une preuve exploitable, spécifique Exadata, en privilégiant les commandes de lecture et les requêtes `SELECT`.
...
emctl config agent listtargets
    ...
    `em-monitoring-checklist.md` avec contexte, commandes, résultats, interprétation, risques, recommandations et annexes.
