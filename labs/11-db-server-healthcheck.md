    # Lab 11 — DB server healthcheck

    ## Objectif

    Contrôler GI, RAC services, ASM et vues instances. Ce lab est conçu pour produire une preuve exploitable, spécifique Exadata, en privilégiant les commandes de lecture et les requêtes `SELECT`.
...
select instance_name,status from gv$instance;
    ...
    `db-server-healthcheck.md` avec contexte, commandes, résultats, interprétation, risques, recommandations et annexes.
