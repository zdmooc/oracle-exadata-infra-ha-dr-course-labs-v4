# Lab 08 — Migration assessment

## Objectif

Ce lab vise à choisir une stratégie RMAN, Data Guard, TTS, Data Pump, GoldenGate ou ZDM. Il est conçu pour être exécuté en priorité en environnement de formation ou de préproduction. Les commandes sont indicatives et doivent être adaptées à votre version et à vos droits.
...
```bash
mkdir -p evidence/lab-08-$(date +%Y%m%d-%H%M%S)
hostname -f
date
uname -a
ip -br addr
