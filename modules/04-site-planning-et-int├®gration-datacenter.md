...
**Alignement Oracle University :** Extension infrastructure-first : site planning, alimentation, câblage, DNS, NTP, IP plan..  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Site Planning et intégration datacenter**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
La réussite d’un déploiement Exadata dépend fortement de la préparation amont : emplacements rack, alimentation redondante, câblage, plages IP, VLAN, routage, DNS, NTP, accès d’administration, fenêtres de changement, règles firewall et accès support. Ce module complète le périmètre Oracle University par une approche terrain indispensable aux projets réels.
