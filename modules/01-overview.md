...
**Alignement Oracle University :** Exadata Database Machine Overview.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Overview**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Exadata combine des serveurs de base de données, des serveurs de stockage intelligents, un réseau interne à faible latence et le logiciel Exadata System Software. L’objectif n’est pas seulement d’héberger une base Oracle, mais d’exécuter les workloads Oracle Database avec des optimisations de stockage, d’I/O, de consolidation et de supervision décrites dans la documentation Oracle Exadata [2].
