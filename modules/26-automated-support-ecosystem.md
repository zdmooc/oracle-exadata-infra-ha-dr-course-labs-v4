...
**Alignement Oracle University :** Extension renforcée : ASR, AHF, SR, collecte et escalade support..  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Automated Support Ecosystem**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
L’écosystème support autour d’Exadata vise à détecter, collecter, diagnostiquer et escalader. Le module couvre les principes d’ASR lorsque applicable, AHF, Exachk, collectes de logs, dossiers de preuves, sévérité d’incident et communication avec le support Oracle, sans inventer d’engagements de SLA.
