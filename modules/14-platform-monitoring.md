# Module 14 — Platform Monitoring

**Alignement Oracle University :** Exadata Database Machine Platform Monitoring Introduction.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Platform Monitoring**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Le monitoring Exadata couvre les couches matérielles, réseau, cellules de stockage, serveurs DB, cluster, ASM, bases et services. La supervision efficace combine Enterprise Manager, métriques Exadata, alertes, journaux, outils Oracle et runbooks d’escalade [1] [2].
