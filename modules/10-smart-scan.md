...
**Alignement Oracle University :** Using Smart Scan.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Smart Scan**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Smart Scan permet à certaines opérations SQL de déplacer une partie du traitement vers les cellules de stockage. L’objectif du module est de vérifier l’éligibilité et l’efficacité de l’offload à partir de plans, statistiques de session et métriques Exadata, sans forcer artificiellement des paramètres de production [1] [3].
