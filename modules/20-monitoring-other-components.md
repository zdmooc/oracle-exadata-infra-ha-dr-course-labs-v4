...
**Alignement Oracle University :** Monitoring Other Exadata Database Machine Components.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Monitoring Other Components**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Une machine Exadata est un système complet. Au-delà des bases et cellules, l’exploitation doit intégrer les composants matériels, interfaces de management, alimentations, ventilateurs, contrôleurs, switchs, journaux et accès support.
