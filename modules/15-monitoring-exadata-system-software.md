...
**Alignement Oracle University :** Monitoring Exadata System Software.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Monitoring Exadata System Software**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Exadata System Software fournit les fonctions intelligentes côté storage et expose des commandes de lecture permettant de vérifier versions, images, alertes, métriques et santé des services. Les commandes de ce module sont orientées inventaire et diagnostic non destructif [3].
