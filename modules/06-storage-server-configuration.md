# Module 06 — Storage Server Configuration

**Alignement Oracle University :** Exadata Storage Server Configuration.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Storage Server Configuration**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Les serveurs de stockage Exadata hébergent les cell disks, grid disks, flash cache, métriques et services du logiciel Exadata. L’administrateur doit savoir lire la configuration avec CellCLI, interpréter l’état matériel et logique, et comprendre comment ASM consomme les objets exposés par les cellules [3].
...
# Lecture seule : cellcli -e list cell detail
# Lecture seule : cellcli -e list celldisk detail
# Lecture seule : cellcli -e list griddisk detail
```
