...
**Alignement Oracle University :** Consolidation Options and Recommendation.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Consolidation**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Exadata est souvent utilisé comme plateforme de consolidation pour plusieurs bases, PDB, services et environnements. La consolidation doit traiter l’isolation, la gouvernance I/O, la priorisation, la supervision, la sauvegarde, les fenêtres de maintenance et la séparation des responsabilités.
