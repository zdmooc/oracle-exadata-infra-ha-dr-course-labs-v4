...
**Alignement Oracle University :** Other Useful Monitoring Tools.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Other Monitoring Tools**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Oracle fournit plusieurs outils de santé et diagnostic, notamment les familles d’outils de vérification et de collecte. Le module structure leur usage en lecture : collecter, horodater, comparer, archiver, interpréter, escalader.
