...
**Alignement Oracle University :** Exadata Database Machine Maintenance Tasks.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Maintenance Tasks**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Les tâches de maintenance incluent inventaire, vérification de santé, nettoyage contrôlé, gestion de capacité, revue des alertes, validation backup, suivi des versions, documentation des changements et préparation support. Le module formalise des runbooks et calendriers opérationnels [4].
