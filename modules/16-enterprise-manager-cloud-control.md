...
**Alignement Oracle University :** Configuring Enterprise Manager Cloud Control to Monitor Exadata Database Machine.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Enterprise Manager Cloud Control**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Enterprise Manager Cloud Control centralise la supervision d’Exadata, des bases, des hôtes, des cellules et de nombreux événements. Le module explique les cibles, les agents, les privilèges, les alertes, les seuils et la valeur d’un tableau de bord opérationnel [1].
