...
**Alignement Oracle University :** Introduction.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Introduction**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Le module installe le cadre pédagogique du workshop. Il rappelle qu’Exadata est une plateforme intégrée pour Oracle Database et que l’administration correcte exige une lecture conjointe des couches datacenter, réseau, serveurs de base de données, serveurs de stockage, ASM, Clusterware, supervision et support. Le cours est indépendant, en français, et aligné sur les thèmes publiés pour Oracle University Exadata Database Machine Administration Workshop [1].
