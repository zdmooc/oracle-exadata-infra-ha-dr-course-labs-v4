...
**Alignement Oracle University :** Migrating Databases to Exadata Database Machine.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Migration to Exadata**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Les migrations vers Exadata peuvent mobiliser RMAN, Data Guard, transportable tablespaces, Data Pump, GoldenGate, ZDM ou des approches hybrides. Le bon choix dépend du volume, de la fenêtre d’arrêt, de la version source, de l’architecture cible, du niveau de risque et des exigences de rollback [1] [6].
