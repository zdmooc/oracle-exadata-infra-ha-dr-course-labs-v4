# Module 18 — Monitoring DB Servers

**Alignement Oracle University :** Monitoring Exadata Database Machine Database Servers.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Monitoring DB Servers**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Les serveurs DB portent Grid Infrastructure, ASM, Oracle Database et les agents de monitoring. Leur supervision doit couvrir CPU, mémoire, réseau client, interconnexion, disques système, services Clusterware, listeners, bases, PDB et jobs de maintenance [1] [5].
