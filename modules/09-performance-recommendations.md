...
**Alignement Oracle University :** Recommendations for Optimizing Database Performance.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Performance Recommendations**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
L’optimisation sur Exadata part de la compréhension des plans d’exécution, des statistiques, des événements d’attente, du placement des données, de la sélectivité, de la compression, du flash et des métriques d’offload. Ce module privilégie les lectures AWR, SQL Monitor et vues dynamiques plutôt que les changements risqués [1] [5].
