...
**Alignement Oracle University :** Patching Exadata Database Machine.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Patching**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Le patching Exadata doit être préparé par des prérequis, sauvegardes, contrôles de santé, compatibilités, fenêtres, plan de rollback, communication et validation post-changement. Les commandes fournies sont de lecture ; toute commande de patching réelle est marquée comme risquée et doit suivre la documentation Oracle applicable [4].
