...
**Alignement Oracle University :** Exadata Cloud Service / Cloud@Customer.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Exadata Cloud Service et Cloud@Customer**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Exadata existe en modèles on-premises, cloud service et Cloud@Customer. Les responsabilités opérationnelles, accès administratifs, modalités de patching, intégrations OCI et périmètres support diffèrent selon le modèle. Ce module aide à transposer les compétences d’administration Exadata vers les environnements cloud Oracle [7] [8].
