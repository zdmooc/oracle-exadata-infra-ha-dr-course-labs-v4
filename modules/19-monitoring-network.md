...
**Alignement Oracle University :** Monitoring the InfiniBand / RoCE Network.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Monitoring Network**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
Le réseau interne Exadata relie compute et storage et constitue un chemin critique pour les performances et la disponibilité. Selon les générations, l’implémentation peut reposer sur InfiniBand ou RoCE ; le module insiste sur la lecture de l’état, des ports, des erreurs et de la redondance sans modification de configuration.
