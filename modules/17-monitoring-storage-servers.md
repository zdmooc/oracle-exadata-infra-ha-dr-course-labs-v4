...
**Alignement Oracle University :** Monitoring Exadata Storage Servers.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **Monitoring Storage Servers**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
La supervision storage suit les cellules, cell disks, grid disks, flash, métriques I/O, alertes matérielles, température, alimentation et état des services. La priorité est de savoir lire et qualifier un symptôme avant d’engager une action corrective [1] [3].
