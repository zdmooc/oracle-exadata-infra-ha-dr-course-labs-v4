...
**Alignement Oracle University :** I/O Resource Management.  
...
À la fin de ce module, l’apprenant doit pouvoir expliquer le périmètre **IORM**, le relier aux composants Exadata concernés, identifier les commandes de lecture utiles, formuler les risques principaux et produire un livrable d’exploitation vérifiable.
...
IORM permet d’arbitrer l’accès aux ressources I/O lorsque plusieurs bases, PDB, services ou catégories de workloads partagent la même plateforme. Le sujet est central pour la consolidation, car une plateforme Exadata mal gouvernée peut présenter des effets de voisinage entre OLTP, reporting, batch et maintenance [1] [3].
